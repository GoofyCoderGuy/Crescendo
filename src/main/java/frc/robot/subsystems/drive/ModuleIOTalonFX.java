...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  private final double DRIVE_GEAR_RATIO = 6.12; //(50.0 / 14.0) * (17.0 / 27.0) * (45.0 / 15.0);
  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0: // front left
        ...
        absoluteEncoderOffset = new Rotation2d(-0.344971); // MUST BE CALIBRATED
        break;
      case 1: //front right
        driveTalon = new TalonFX(13);
        turnTalon = new TalonFX(23);
        cancoder = new CANcoder(33);
        absoluteEncoderOffset = new Rotation2d(-0.343262); // MUST BE CALIBRATED
        break;
      case 2: //back left
        driveTalon = new TalonFX(12);
        turnTalon = new TalonFX(22);
        cancoder = new CANcoder(32);
        absoluteEncoderOffset = new Rotation2d(-0.216309); // MUST BE CALIBRATED
        break;
      case 3: //back right
        driveTalon = new TalonFX(11);
        turnTalon = new TalonFX(21);
        cancoder = new CANcoder(31);
        absoluteEncoderOffset = new Rotation2d(-0.359131); // MUST BE CALIBRATED
        break;
      default:
